...
//
// `checkoutEnabled` gates the block-purchase CTA. It stays false until the
// /api/checkout function sells blocks instead of the retired $49/mo
// subscription — tracked as a P34 follow-up. Flip to true once that ships.
