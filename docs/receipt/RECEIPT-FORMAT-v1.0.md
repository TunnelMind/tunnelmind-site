...
**Status:** DRAFT (Phase-2 deliverable). Awaiting Josh review before any service wiring.
**License:** spec CC BY 4.0 · reference code Apache-2.0.
**Companion:** [EAT Profile v0.1](../EAT-PROFILE-v0.1.md) is the RATS-aligned (CWT/JWT)
