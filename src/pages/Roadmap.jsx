...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { name: 'Corpus inspector — the right panel of the Radar', status: 'active', desc: 'The NetProbe domain-intelligence tool, repurposed as the right-hand surface of the Radar so clicking any node — or typing any domain or IP — yields WHOIS, DNS, certificate transparency, tracker scores, and reputation across the corpus. Same surface for humans and for agents over MCP.' },
