...
export const SECTIONS = [
  {
    ...
    items: [
      ...
      { name: 'Three MCP servers', status: 'live', desc: 'JSON-RPC 2.0 over streamable HTTP, all listed in the official MCP registry: mcp.tunnelmind.ai (Scry, 12 tools), mcp-data.tunnelmind.ai (Data, 67 tools), mcp.sigil.tunnelmind.ai (Sigil, 12 tools). Same corpus, structured for a model to consume directly.' },
