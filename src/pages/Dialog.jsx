  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', background: 'var(--doc-bg)' }}>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '64px 32px', textAlign: 'center' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: '32px', fontWeight: 400, color: 'var(--doc-text)', marginBottom: '16px', lineHeight: 1.3 }}>The collaborative graph has moved to Alloy.</h1>
        <p style={{ fontFamily: 'var(--font-serif)', fontSize: '18px', color: 'var(--doc-text-dim)', lineHeight: 1.7, marginBottom: '32px' }}>Read, annotate, vote, and propose corrections — and earn a share of platform revenue for your contributions.</p>
